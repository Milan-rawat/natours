...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWlsYW5yYXdhdCIsImEiOiJja2thdzBlZWMxOGF2MnVsbmFnZW9sYXFhIn0.mfxBioCE8J38g4Hs8E7lDA';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging ou! Try again.');
...
var stripe = Stripe('pk_test_51IFYmSAAL6MW4VS4HhyuuiuQzcMkcK2TkB3eXL2rPAoVOkAmtsM9ORLy0xoDPzdPZvAX8rlrFbJULTOOPPNjQId200MSP9GflK');
...
console.log('in index.js file'); // VALUES

if (userDataForm) console.log('true');
if (!userDataForm) console.log('false'); // DELEGATION
